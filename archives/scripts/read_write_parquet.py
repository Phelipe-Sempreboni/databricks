...
datafparquet.write.parquet("/FileStore/tables/Arquivos/parquet/pessoal.parquet")

# COMMAND ----------

# DBTITLE 1,Subscrevendo o arquivo parquet.
#Permite uma atualização do arquivo parquet
datafparquet.write.mode('overwrite').parquet("/FileStore/tables/Arquivos/parquet/pessoal.parquet")

# COMMAND ----------

# DBTITLE 1,Lendo o arquivo parquet e guardando em um DataFrame.
#Realizando uma atualização do arquivo parquet
datafleitura = spark.read.parquet("/FileStore/tables/Arquivos/parquet/pessoal.parquet")
datafleitura.show()
...
#Particionando os dados em um arquivo parquet
datafparquet.write.partitionBy("Nacionalidade","salario").mode("overwrite").parquet("/FileStore/tables/Arquivos/parquet/pessoal.parquet")
...
#Lendo o aquivo participonado do parquet
datafnacional=spark.read.parquet("/FileStore/tables/Arquivos/parquet/pessoal.parquet/Nacionalidade=Brasileira")
...
spark.sql("CREATE OR REPLACE TEMPORARY VIEW Cidadao USING parquet OPTIONS (path\"/FileStore/tables/Arquivos/parquet/pessoal.parquet/Nacionalidade=Brasileira\")")
